...
<div class="py-12 w-full">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <h1 class="uppercase text-2xl font-semibold tracking-widest text-white ml-4 mt-10">Edit genre</h1>
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('admin.genres.update', ['genre' => $genre->id]) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <x-text-input type="text" name="name" id="name" value="{{ old('name') ?? $genre->name}}"
