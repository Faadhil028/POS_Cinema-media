            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="border-t border-gray-700 mt-6 pt-6">
                        <h2 class="text-xl font-semibold mb-4">Fitur Dashboard Bioskop</h2>
                        <ul class="list-disc list-inside mb-4">
                            <li class="text-lg">Manajemen Jadwal Film</li>
                            <li class="text-lg">Pemesanan Tiket </li>
                            <li class="text-lg">Pengelolaan Data Pelanggan</li>
                            <li class="text-lg">Laporan Penjualan</li>
                        </ul>
                        <p class="text-lg">Dashboard ini memberikan kemudahan dan visualisasi yang intuitif untuk
                            membantu Anda
                            memahami operasional bioskop dengan efektif dan efisien.</p>
                    </div>
                </div>
