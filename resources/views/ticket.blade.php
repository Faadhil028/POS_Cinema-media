...
<head>
    ...
    <title>Cinema Media Ticket</title>
...
<body>
    ...
    @foreach (explode(',', $tickets['seat']) as $item)
        <div class="cardWrap">
            <div class="card cardLeft">
                <h1>Cinema <span>Media</span></h1>
                <div class="title">
                    <h2>{{ $tickets['film'] }}</h2>
                    <span>movie</span>
                </div>
                <div class="name">
                    <h2>{{ $tickets['studio'] }}</h2>
                </div>
                <div class="seat">
                    <h2>{{ $item }}</h2>
                    <span>seat</span>
                ...
                <div class="time">
                    <h2>{{ \Carbon\Carbon::parse($tickets['start_time'])->format('H:i') }}</h2>
                    <span>time</span>
                </div>
                <div class="date">
                    <h2>{{ \Carbon\Carbon::parse($tickets['transaction_time'])->format('d/m/Y') }}</h2>
                    <span>date</span>
                </div>
            </div>
