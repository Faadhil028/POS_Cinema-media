                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex">
                                            <button wire:click='edit({{ $seat->id }})'
                                                class="font-medium text-sky-500 hover:underline px-1">Edit </button>
                                            {{-- @if ($seat->transactions()->doesntHave('seats')->exists()) --}}
                                            /
                                            <!-- <a href="#" class="font-medium text-sky-500 hover:underline">Delete</a> -->
                                            <form method="POST" action="{{ route('admin.seats.destroy', $seat->id) }}"
